              ...
              {(() => {
                ...
                return dashboardAd?.image && dashboardAd?.url ? (<a
                  ...
                  <div
                    ...
                    className="bg-gradient-to-br from-yellow-200/80 via-yellow-100/70 to-lime-100/60 rounded-lg p-12 flex items-center justify-center border-2 border-dashed border-gray-300 hover:border-[#D0ED00] transition-all cursor-pointer hover:shadow-md backdrop-blur-sm"
                    style={{ aspectRatio: '1200/300' }}
                  >
